...
{
    public class GetAccountsQueryHandler : IRequestHandler<GetAccountsQuery, AccountsDto>
    {
        ...
        public async Task<AccountsDto> Handle(GetAccountsQuery getAccountsQuery, CancellationToken none)
        {
